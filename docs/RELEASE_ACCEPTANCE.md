...
| 5 | Mehrere PDF-/TXT-/CSV-Bons gemeinsam auswählen und zusätzlich einen Bildbon auswählen; erkannte Artikelzeilen prüfen und speichern | Textbasierte Dateien werden gemeinsam eingelesen; Bild/Scan bleibt als ausgewählte Referenz sichtbar; bestätigte Bonpreise erscheinen beim richtigen Markt und haben Vorrang |  | ☐ |
