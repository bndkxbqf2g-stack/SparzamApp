...
- **Bon:** Bestätigte Einkäufe erscheinen in einer lokalen Historie und können bearbeitet oder gelöscht werden. Bonpreise lassen sich aus geprüften Text-/CSV-Zeilen übernehmen und haben als bestätigte Preise Vorrang vor externen oder geschätzten Werten. Bild- und PDF-Belege können ausgewählt und anschließend manuell übertragen werden. Der Warenkorb belastet das Lebensmittelbudget, Fahrtkosten nicht.
...
Automatische OCR für Fotos/PDFs, originale Händlerprospekte aus den Apps von Lidl, Kaufland, Netto usw. sowie gemeinsames Bearbeiten über mehrere Geräte benötigen zusätzliche OCR-, Händler- oder Backend-Dienste und sind nicht Bestandteil der lokalen Version 1. Die Auswahl eines Bild-/PDF-Bons dient aktuell als Referenz für die geprüfte manuelle Übertragung; TXT/CSV kann direkt eingelesen werden.
